...
export const profile = {
  ...
  shortName: 'Samson',
  initials: 'SA',
  title: 'Full-Stack Developer building AI-powered systems end-to-end',
  ...
  availability: 'Open to full-stack and systems-focused roles',
...
export const heroStats: HeroStat[] = [
  ...
  { value: 100, suffix: '+', label: 'Integrated Workflows' },
];

export const trustPoints = [
  'Full-stack delivery across frontend, backend logic, APIs, databases, and integrations',
  'Systems built for intake, CRM, onboarding, billing, reporting, and internal operations',
  'AI and automation used as leverage after the product and data foundations are in place',
];
...
export const expertiseAreas: ExpertiseArea[] = [
  {
    ...
    description:
      'Product-facing systems built from the interface through the backend logic that supports them.',
    bullets: [
      'React, Next.js, TypeScript, and modern frontend architecture',
      'Node.js services, backend flows, and business logic',
      'User-facing forms, dashboards, portals, and internal tools',
      'Frontend and backend designed to work as one system',
    ],
  },
  {
    title: 'API Integrations',
    description:
      'API and webhook integrations that connect products to CRMs, billing tools, inboxes, and third-party platforms.',
    bullets: [
      'REST APIs and webhook-based flows',
      'Authentication, mapping, and payload normalization',
      'Cross-platform synchronization and event-driven workflows',
      'Structured handoffs between product and operations',
    ],
  },
  {
    title: 'Systems Architecture',
    description:
      'Modular systems with clear boundaries, maintainable flows, and enough structure to scale without becoming brittle.',
    bullets: [
      'System boundaries, lifecycle modeling, and operational state design',
      'Modular workflows and maintainable service connections',
      'Architecture that supports team visibility and future change',
      'Scalability-minded implementation choices from day one',
    ],
  },
  {
    title: 'Operational Platforms',
    description:
      'Backend systems that move work from lead capture to onboarding, billing, reporting, and team execution.',
    bullets: [
      'CRM architecture, intake flows, and lifecycle tracking',
      'Backend processes for routing, onboarding, and reporting',
      'Internal systems that reduce manual coordination',
      'Operational logic tied directly to business outcomes',
    ],
  },
  {
    title: 'AI and Automation Layer',
    description:
      'AI and automation added where they strengthen a system, not where they replace engineering discipline.',
    bullets: [
      'GPT-assisted classification, generation, and enrichment',
      'n8n, Make.com, Zapier, and agentic workflow orchestration',
      'Automation layered onto stable product and data foundations',
      'Validation, guardrails, and human-aware workflow design',
    ],
  },
];
...
export const platformGroups: PlatformGroup[] = [
  {
    ...
    note: 'The stack I use to build applications and product surfaces.',
    items: [
  ...
  {
    title: 'Systems & Architecture',
    note: 'Reliable flows across backend logic, integrations, and operations.',
    items: [
      { name: 'REST APIs and webhooks', primary: true },
      { name: 'Backend logic and lifecycle design', primary: true },
  ...
  {
    title: 'AI & Automation',
    note: 'Applied after the product and systems foundation is defined.',
    items: [
      { name: 'OpenAI / GPT workflows', primary: true },
  ...
  },
  {
    ...
    note: 'Operational systems that support intake, routing, and onboarding.',
    items: [
      { name: 'HubSpot', primary: true },
      { name: 'GoHighLevel', primary: true },
      { name: 'Airtable' },
      { name: 'Google Sheets' },
      { name: 'Slack / Asana / Notion' },
    ],
  },
  {
    title: 'Payments & Billing',
    note: 'Billing and contract systems connected to the wider workflow.',
    items: [
  ...
  },
  {
    ...
    note: 'The kinds of systems I have shipped in production.',
    items: [
...
export const faqs: FAQItem[] = [
  {
    ...
    answer:
      'I am strongest in full-stack, systems, integrations, and product-adjacent engineering roles where frontend delivery, backend logic, and operational workflows need to work together.',
  },
  {
    question: 'How do you use AI in your work?',
    answer:
      'I use AI as a force multiplier inside well-designed systems. That usually means classification, generation, enrichment, or agentic workflow steps layered onto solid product architecture and integration logic.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'I design around explicit lifecycle states, validation, fallback paths, deduplication, and maintainable boundaries so the system keeps working when real-world edge cases show up.',
  },
  {
    question: 'What kinds of systems are the best fit for your background?',
    answer:
      'The best fit combines product-facing software with APIs, integrations, internal tooling, CRM logic, or automation where system design matters just as much as implementation speed.',
  },
  {
    question: 'Are you open to remote roles or contract work?',
    answer:
      'Yes. I am open to remote roles, contract work, and systems-focused opportunities where I can build full-stack products and layer AI or automation where it adds leverage.',
  },
];
