...
const colorMap = {
  ...
  automation: {
    ...
    label: 'System + Automation Layer',
  },
};

const filters: { label: string; value: Filter }[] = [
  { label: 'All Projects', value: 'all' },
  { label: 'Full-Stack Systems', value: 'web-crm' },
  { label: 'Systems + Automation', value: 'automation' },
];

const automationFitCopy: Record<Project['title'], string> = {
  'HOSVI LLC':
    'Automation handled lifecycle timing and downstream handoffs after the website, CRM structure, and billing architecture were in place.',
  Advitravel:
    'Automation supported routing and synchronization, but the core build was the website, data model, and operating structure behind it.',
  'Sunlife Housing Corp':
    'Automation handled routing and deduplication, while the core engineering work was the website-to-CRM system design.',
  'Smart Email Intake & Routing System':
    'AI was one step in the intake pipeline. The real system was the routing architecture and the connected downstream actions.',
  'Automated Lead Nurture Workflow':
    'Automation was the execution layer on top of a clearly designed event flow, ownership model, and multi-system handoff.',
  'Federal Contract Opportunity Automation':
    'This was primarily backend integration and workflow engineering rather than AI. The value came from dependable retrieval, filtering, and delivery.',
  'GoHighLevel Seminar Automation':
    'This project focused on operational systems design and lifecycle automation rather than AI-heavy logic.',
  'Automated Weekly Regulation Report':
    'GPT handled the final generation step, but reliability came from the ingestion pipeline, normalization, and reporting structure around it.',
  'Social Media Posting Automation':
    'This was a systems and workflow design project. Automation scaled a stronger content-state model and publishing process.',
};
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <SectionHeading
            ...
            description="Case studies focused on product architecture, backend logic, integrations, and where AI or automation fits inside the larger system."
          />
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                  ...
                  <div className="mt-6 rounded-2xl border border-white/10 bg-black/10 p-5">
                    ...
                    <p className="mt-2 text-sm leading-6 text-gray-300">
                      {automationFitCopy[selectedProject.title] ??
                        'Automation supports the system after the product and integration foundations are established.'}
                    </p>
                  </div>
                </div>
