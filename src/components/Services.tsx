...
const iconMap = {
  'Full-Stack Applications': <Code2 size={26} />,
  'API Integrations': <TrendingUp size={26} />,
  'Systems Architecture': <ShieldCheck size={26} />,
  'Operational Platforms': <Database size={26} />,
  'AI and Automation Layer': <Zap size={26} />,
};
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <SectionHeading
            ...
            description="I lead with engineering fundamentals: product interfaces, backend logic, integrations, and system design. AI and automation come in as the scaling layer."
          />
            ...
            <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-glow-blue">
              <div>
                <h3 className="text-xl font-heading font-bold text-white mb-1">
                  Looking for end-to-end system ownership?
                </h3>
                <p className="text-primary-100 text-sm">
                  I&apos;m strongest where the product, backend logic, integrations, and operations all need to work together.
                </p>
              </div>
              <motion.a
                href="#portfolio"
