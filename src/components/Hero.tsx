...
import { ArrowRight, Braces, ChevronDown, Cpu, Download, Layers3, Server, Sparkles } from 'lucide-react';
import ParticleBackground from './ui/ParticleBackground';
import CountUpStat from './shared/CountUpStat';
import { heroStats, profile, trustPoints } from '../data/portfolio';

const toolTags = [
  { icon: <Braces size={13} />, label: 'React / Next.js' },
  { icon: <Server size={13} />, label: 'Node.js APIs' },
  { icon: <Layers3 size={13} />, label: 'Systems Architecture' },
  { icon: <Cpu size={13} />, label: 'Integrations' },
  { icon: <Sparkles size={13} />, label: 'AI Automation Layer' },
];
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="max-w-6xl mx-auto w-full text-center">
          ...
          >
            ...
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-heading font-semibold text-gray-300 mt-4 leading-snug max-w-4xl mx-auto">
              {profile.title}
            </h2>
          </motion.div>
          ...
          >
            I build full-stack applications from the frontend through the integration layer, then use AI and automation to make those systems faster, smarter, and easier to scale.
          </motion.p>
          ...
          >
            Strong fit for full-stack, integrations, platform, and systems-focused engineering roles.
          </motion.p>
