...
const iconMap = {
  'Core Engineering': <Globe size={20} />,
  'Systems & Architecture': <Server size={20} />,
  'AI & Automation': <Cpu size={20} />,
  'CRM & Operations': <Database size={20} />,
  'Payments & Billing': <Layout size={20} />,
  'Delivery Context': <Layers size={20} />,
};
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <SectionHeading
            align="center"
            eyebrow="Stack"
            title="Engineering Stack and Systems Toolkit"
            description="Core engineering comes first here. The automation layer is important, but it sits on top of product development, integrations, and system design."
          />
        ...
        >
          <p className="text-gray-500 dark:text-gray-400 mb-5 text-sm">
            Want help choosing the right architecture and stack for your product?
          </p>
          <motion.a
            href="#contact"
